...
const Greetings = () => {
  ...
  const getGreetings = async () => {
    try {
      const response = await axios.get('https://backends-coral.vercel.app/api/greet/greet');
  ...
  const handleEditSubmit = async () => {
    ...
    try {
      const response = await axios.patch(
        `https://backends-coral.vercel.app/api/greet/greet/${editedGreet.id}`,
  ...
  //   try {
  //     await axios.delete(`https://backends-coral.vercel.app/api/greet/greet/${itemIdToDelete}`);
  ...
  const createGreet = async () => {
    ...
    try {
      if (!dataAdded) {
        const response = await axios.post('https://backends-coral.vercel.app/api/greet/greet', {
          greet: trimmedGreet,
  ...
  const updateGreet = async (greetId) => {
    ...
    try {
      const response = await axios.patch(`https://backends-coral.vercel.app/api/greet/greet/${greetId}`, updateGreetData);
