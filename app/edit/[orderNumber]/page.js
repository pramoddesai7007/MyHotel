...
const EditOrderPage = ({ params, tableId }) => {
      ...
      try {
        if (orderNumber) {
          ...
          const orderResponse = await axios.get(
            `https://backends-coral.vercel.app/api/order/get/order/${orderNumber}`
          );
          ...
          const sectionResponse = await axios.get(
            `https://backends-coral.vercel.app/api/section/sectionlist/${tableId}`
          );
  ...
  //     const initialOrderResponse = await axios.get(`https://backends-coral.vercel.app/api/order/get/order/${orderNumber}`);
  //     const initialOrderData = initialOrderResponse.data;

  //     // Log the initial state of the order before any updates
  //     await axios.post(`https://backends-coral.vercel.app/api/logHistory/log-history`, {
  ...
  //     const updateOrderEndpoint = `https://backends-coral.vercel.app/api/order/update-order-by-number/${orderNumber}`;
  ...
  const handleSaveBill = async () => {
    try {
      ...
      const tableResponse = await axios.get(
        `https://backends-coral.vercel.app/api/table/tables/${tableId}`
      );
