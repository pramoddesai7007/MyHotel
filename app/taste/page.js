...
const TasteList = () => {
  ...
  useEffect(() => {
    const fetchTastes = async () => {
      try {
        const response = await axios.get('https://backends-coral.vercel.app/api/taste/tastes');
  ...
  const handleEditSubmit = async (e) => {
    ...
    try {
      ...
      await axios.patch(`https://backends-coral.vercel.app/api/taste/tastes/${selectedTaste._id}`, {
  ...
  const handleDeleteSubmit = async () => {
    try {
      ...
      await axios.delete(`https://backends-coral.vercel.app/api/taste/tastes/${selectedTaste._id}`);
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      await axios.post('https://backends-coral.vercel.app/api/taste/tastes', { taste: newTaste });
