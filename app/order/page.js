...
import { faCirclePlus, faCircleMinus, faTimes, faTableColumns, faObjectUngroup } from "@fortawesome/free-solid-svg-icons";
...
const Billing = ({ tableId, acPercentage }) => {
  ...
  const handleCancelKOT = async () => {
    try {
      ...
      await axios.delete(`https://backends-coral.vercel.app/api/kot/${tableId}`, {
    ...
    const fetchTastes = async () => {
      try {
        const response = await axios.get(
          "https://backends-coral.vercel.app/api/taste/tastes"
        );
  ...
  const fetchWaitersList = async () => {
    try {
      const response = await axios.get("https://backends-coral.vercel.app/api/waiter");
  ...
  useEffect(() => {
    const fetchGreetings = async () => {
      try {
        const response = await axios.get(
          "https://backends-coral.vercel.app/api/greet/greet"
        );
  ...
  useEffect(() => {
    ...
    const fetchNextOrderNumber = async () => {
      try {
        const response = await axios.get(
          "https://backends-coral.vercel.app/api/order/get-next-order-number"
        );
  ...
  const fetchLastAllOrders = async () => {
    try {
      const ordersResponse = await axios.get(
        "https://backends-coral.vercel.app/api/order/latest-orders"
      );
      ...
      const tableNamesPromises = orders.map(async (order) => {
        const tableResponse = await axios.get(
          `https://backends-coral.vercel.app/api/table/tables/${order.tableId}`
        );
  ...
  const saveBill = async () => {
    try {
      ...
      const existingBillResponse = await axios.get(
        `https://backends-coral.vercel.app/api/order/order/${tableId}`
      );
      ...
      if (existingBill && existingBill.length > 0) {
        ...
        const updateResponse = await axios.patch(
          `https://backends-coral.vercel.app/api/order/update-order-by-id/${orderIdToUpdate}`,
          orderData
        );
      ...
      const KOTResponse = await axios.post(
        `https://backends-coral.vercel.app/api/kot/kotOrder/${tableId}`,
        kotData
      );
  ...
  const saveKot = async () => {
    try {
      ...
      const existingKOTResponse = await axios.get(
        `https://backends-coral.vercel.app/api/kot/kot/${tableId}`
      );
  ...
  const handlePrintBill = async () => {
    try {
      ...
      if (temporaryOrderIndex !== -1) {
        ...
        await axios.patch(`https://backends-coral.vercel.app/api/kot/kot/settle/${tableId}`);
...
<script>
  ...
  useEffect(() => {
    ...
    // Fetch categories
    axios
      .get("https://backends-coral.vercel.app/api/main")
      .then((response) => {
    ...
    // Fetch products
    axios
      .get("https://backends-coral.vercel.app/api/menu/menus/list")
      .then((response) => {
    ...
    // if (tableId) {
    //   axios
    //     .get(`https://backends-coral.vercel.app/api/table/tables/${tableId}`)
    //     .then((response) => {
    ...
    if (tableId) {
      axios
        ...
        .then((response) => {
          ...
          axios
            .get(`https://backends-coral.vercel.app/api/order/savedBills/${tableId}`)
            .then((response) => {
  ...
  useEffect(() => {
    ...
    if (selectedCategory) {
      axios
        .get(`https://backends-coral.vercel.app/api/menu/${selectedCategory._id}`)
        .then((response) => {
          // console.log(response.data);
          const menusArray = response.data || []; // Ensure menus is an array
          setMenus(menusArray);
  ...
  const handleCategoryClick = (category) => {
    ...
    if (category === null) {
      ...
      // Fetch menus based on the selected category
      axios
        .get(`https://backends-coral.vercel.app/api/menu/menulist/${category._id}`)
        .then((response) => {
          setMenus(response.data);
        })
        .catch((error) => {
    ...
    const fetchHotelInfo = async () => {
      try {
        ...
        const allHotelsResponse = await axios.get(
          "https://backends-coral.vercel.app/api/hotel/get-all"
        );
        ...
        if (defaultHotelId) {
          ...
          const response = await axios.get(
            `https://backends-coral.vercel.app/api/hotel/get/${defaultHotelId}`
          );
  ...
  const handleEditSubmit = async () => {
    try {
      ...
      const response = await axios.patch(
        `https://backends-coral.vercel.app/api/table/tables/${editTable._id}`,
        formData,
        {
          headers: {
  ...
  useEffect(() => {
    ...
    const fetchSections = async () => {
      try {
        const sectionsResponse = await axios.get('https://backends-coral.vercel.app/api/section');
  ...
  const handleAddSubmit = async () => {
    try {
      ...
      const response = await axios.post(
        `https://backends-coral.vercel.app/api/table/${sectionId}/tables`,
        { numberOfTables },
        {
          headers: {
            "Content-Type": "application/json",
  ...
  //   try {
  //     const response = await axios.patch('https://backends-coral.vercel.app/api/order/mergeTables', {
  //       destinationTableId,
  //       sourceTableId,
  //     });
  ...
  const handleMergeTables = async (sectionId, destinationTableName, sourceTableName) => {
    try {
      ...
      const destinationTableResponse = await axios.get(`https://backends-coral.vercel.app/api/table/table/bySectionAndName/${sectionId}/${destinationTableName}`);
      ...
      const sourceTableResponse = await axios.get(`https://backends-coral.vercel.app/api/table/table/bySectionAndName/${sectionId}/${sourceTableName}`);
        ...
        <div className="flex lg:flex-row shadow-lg ">
          <div className=" w-full lg:w-2/5 bg-gray-200 -mt-3 md:w-96 relative">
            ...
            <div className="font-bold text-sm px-3 flex mt-2 whitespace-nowrap">
              ...
              h-7 shadow-inner border border-gray-400 lg:ml-56"
                    ...
                    >
                      <div>
                        ...
                        <div className="justify-center flex">
                          <img
                            src={product.imageUrl ? `https://backends-coral.vercel.app/${product.imageUrl}` : `/tray.png`}
