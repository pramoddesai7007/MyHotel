...
const Section = () => {
  ...
  useEffect(() => {
    const fetchSections = async () => {
      try {
        const response = await axios.get("https://backends-coral.vercel.app/api/section");
  ...
  const handleEditSubmit = async () => {
    ...
    try {
      ...
      await axios.patch(
        `https://backends-coral.vercel.app/api/section/${sectionToEdit._id}`,
        {
  ...
  const handleDeleteConfirmed = async () => {
    ...
    try {
      await axios.delete(
        `https://backends-coral.vercel.app/api/section/${sectionToDelete._id}`
      );
  ...
  const handleAddSubmit = async () => {
    try {
      ...
      const response = await axios.post(
        "https://backends-coral.vercel.app/api/section/create",
        formData,
        {
          headers: {
